 ...
 *
 */
export const CardLargeImage: React.FC<CardLargeImageProps> = ({
  image,
  alt,
  text,
  button,
 ...
 *
 */
export const CardContent: React.FC<CardSmallImageProps> = ({
  bg,
  color,
  icon,
  title,
